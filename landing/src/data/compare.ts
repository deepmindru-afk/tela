...
export const competitors: Competitor[] = [
  {
    ...
    lead: 'Notion — это мощное универсальное рабочее пространство, но ваши страницы хранятся в проприетарной блочной базе данных, оно доступно только в облаке, и ничто в нём не пишет документацию из вашего кода. portal — это markdown-ориентированная, саморазмещаемая и агент-ориентированная платформа, а Atlas создаёт вики с цитированием прямо из ваших git-репозиториев и Jira.',
    rows: [
  ...
  },
  {
    ...
    lead: 'Confluence тяжёл, а его AI (Rovo) тарифицируется в кредитах, причём лучший AI доступен на более дорогих тарифах. И, как и другие устаревшие решения, он не умеет писать документацию из вашего исходного кода. portal — лёгкая, markdown-ориентированная, AI-нативная противоположность — а Atlas поддерживает вики в актуальном состоянии, генерируя её из ваших git-репозиториев и Jira.',
    rows: [
  ...
  },
  {
    ...
    whenBetter:
      'Если ваша задача — красивая публичная документация для разработчиков — версионированные API-референсы, многоверсионная документация для библиотеки с открытым кодом, брендированный сайт документации — GitBook отличен и его трудно превзойти. portal — это командная вики, а не платформа для публикации документации.',
  ...
  },
  {
    ...
    metaDescription:
      'Саморазмещаемая альтернатива Slite с открытым исходным кодом. portal — это AGPL markdown, который вам принадлежит — с поиском по документам, встроенным MCP-сервером и Atlas для создания вики с цитированием из вашего кода.',
  ...
  },
  {
    ...
    metaDescription:
      'Открытая альтернатива Coda с самостоятельным размещением. portal — это AGPL канонический markdown, а не проприетарное полотно из блоков и формул — с поиском по документам, встроенным MCP-сервером и Atlas.',
    heading: 'Открытая альтернатива Coda с самостоятельным размещением для документации, которой вы владеете',
    lead: 'Coda — это мощное полотно «документ-как-приложение» — таблицы, формулы, Packs, официальный MCP-сервер, AI в документах. Но он также проприетарный, только облачный, с ценой за Doc Maker и хранением контента в собственном формате. portal — более лёгкое предложение: открытая, саморазмещаемая, markdown-ориентированная командная вики, где знания остаются в markdown, который вам принадлежит. Если вы обратились к Coda для документирования команды и вам не нужна его машинерия таблиц-и-баз-данных, portal — альтернатива, которая вам принадлежит.',
    rows: [
      { feature: 'License', tela: TELA_LICENSE, them: 'Проприетарное SaaS' },
      { feature: 'Self-hostable', tela: TELA_SELFHOST, them: 'Нет — только облако' },
  ...
  },
  {
    ...
    metaDescription:
      'Современная альтернатива MediaWiki на markdown. portal — открытый код (AGPL), self-hosted — без викитекста, без тяжёлого администрирования — с поиском по документам, встроенным MCP-сервером и Atlas.',
