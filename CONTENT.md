...
One-page marketing landing page. Standalone, anchored sections. Hosted instance + product: https://tla.portalos.ru
...
- **Primary CTA:** `Get started` → https://tla.portalos.ru (hosted, free to start).  **Secondary CTA:** `Add to Claude or ChatGPT` → the MCP/connect section (`#agents`).
...
- **Show the connect flow (3 steps, real):**
  1. In Claude or ChatGPT, add a connector → `https://tla.portalos.ru/api/mcp`
...
- **Primary CTA:** `Get started` → https://tla.portalos.ru.  **Secondary:** `Add to Claude or ChatGPT` → `#agents` / `/mcp`.
